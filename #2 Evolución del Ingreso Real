...
/*
Comparto mi código que permite replicar la evolución del ingreso y gasto real per cápita promedio mensual,
tal como se presenta en el informe "Evolucion de la pobreza monetaria 2010 - 2021" del 
Instituto Nacional de Estadística (INEI) para el período 2017-2021. Utilizo parte de la sintaxis 
encontrada en el módulo 34 Sumaria de la Encuesta Nacional de Hogares (ENAHO) 
correspondiente al periodo 2016-2019.
*/

Fuente: https://www.inei.gob.pe/media/MenuRecursivo/publicaciones_digitales/Est/pobreza2021/Pobreza2021.pdf


global ruta "C:\Users\JOSE\Desktop\BD_ERESTE_2021\BD_ENAHO_ANUAL"
cd $ruta

*---------------------------------------------------
** A nivel percapita , ingreso promedio real mensual
*---------------------------------------------------

use sumaria-2021.dta  , clear
append using sumaria-2020.dta 
...
*/12"Junin" 13"La_Libertad" 14"Lambayeque" 15"Lima" 16"Loreto" 17"Madre_de_Dios" 18"Moquegua" 19"Pasco" 20"Piura" 21"Puno" 22"San_Martin" 23"Tacna" 24"Tumbes" 25"Ucayali" 
lab val dpto dpto 

*Agrego la base que contiene los deflactores
sort  aniorec dpto
merge aniorec dpto using deflactores_base2021_new.dta
tab _m
drop if _merge==2
drop _m
...
*Calculamos el factor de ponderacion a nivel poblacional
...
************* Ingresos ****************************************************************.
gen ipcr_2 = (ingbruhd +ingindhd)/(12*ld*i00)
gen ipcr_3 = (insedthd + ingseihd)/(12*ld*i00)
gen ipcr_4 = (pagesphd + paesechd + ingauthd + isecauhd)/(12*ld*i00)
gen ipcr_5 = (ingexthd)/(12*ld*i00)
gen ipcr_1 = (ipcr_2 + ipcr_3 + ipcr_4 + ipcr_5)

gen ipcr_7 = (ingtrahd)/(12*ld*i00)
gen ipcr_8 = (ingtexhd)/(12*ld*i00)
gen ipcr_6 = (ipcr_7 + ipcr_8)

gen ipcr_9  = (ingtprhd)/(12*ld*i00)
gen ipcr_10 = (ingtpuhd)/(12*ld*i00)
gen ipcr_11 = (ingtpu01)/(12*ld*i00)
gen ipcr_12 = (ingtpu03)/(12*ld*i00)
gen ipcr_13 = (ingtpu05)/(12*ld*i00)
gen ipcr_14 = (ingtpu04)/(12*ld*i00)
gen ipcr_15 = (ingtpu02)/(12*ld*i00)
gen ipcr_16 = (ingrenhd)/(12*ld*i00)
gen ipcr_17 = (ingoexhd + gru13hd3 + gru23hd3 + gru33hd3 + gru43hd3 + gru53hd3 + gru63hd3 + gru73hd3 + gru83hd3 + gru24hd +gru44hd + gru54hd + gru74hd + gru84hd + gru14hd5)/(12*ld*i00)

*ajuste por el alquiler imputado
gen ipcr_18 =(ia01hd +gru34hd - ga04hd + gru64hd)/(12*ld*i00)

gen ipcr_19 = (gru13hd1 + sig24 + gru23hd1 + gru33hd1 + gru43hd1 + gru53hd1 + gru63hd1 + gru73hd1 + gru83hd1 + gru14hd3 + sig26)/(12*ld*i00)

gen ipcr_20 = (gru13hd2 + ig06hd + gru23hd2 + gru33hd2 + gru43hd2 + gru53hd2 + gru63hd2 + ig08hd + gru73hd2 +gru83hd2 + gru14hd4 + sg42d + sg42d1 + sg42d2 + sg42d3)/(12*ld*i00)


gen  ipcr_0= ipcr_2 + ipcr_3 + ipcr_4 + ipcr_5+ ipcr_7 + ipcr_8 + ipcr_16 + ipcr_17 + ipcr_18 + ipcr_19 + ipcr_20

label var ipcr_0 "Ingreso  mensual a precios de Lima monetario"
label var ipcr_1 "Ingreso  mensual a precios de Lima monetario por trabajo"
label var ipcr_2 "Ingreso  mensual a precios de Lima monetario por trabajo principal"
label var ipcr_3 "Ingreso  mensual a precios de Lima monetario por trabajo secundario"
label var ipcr_4 "Ingreso  mensual a precios de Lima pago en especie y autocon"
label var ipcr_5 "Ingreso  mensual a precios de Lima pago extraordinario por trabajo"
label var ipcr_6 "Ingreso  mensual a precios de Lima transferencia corriente"
label var ipcr_7 "Ingreso  mensual a precios de Lima transferencia monetaria del pais"
label var ipcr_8 "Ingreso  mensual a precios de Lima transferencia monetaria extranjero"
label var ipcr_9  "Ingreso  mensual a precios de Lima transferencia monetaria privada"
label var ipcr_10 "Ingreso  mensual a precios de Lima transferencia monetaria Publica total"
label var ipcr_11 "Ingreso  mensual a precios de Lima transferencia monetaria Publica Juntos"
label var ipcr_12 "Ingreso  mensual a precios de Lima transferencia monetaria Publica Pensión65"
label var ipcr_13 "Ingreso  mensual a precios de Lima transferencia monetaria Bono Gas"
label var ipcr_14 "Ingreso  mensual a precios de Lima transferencia monetaria Beca 18"
label var ipcr_15 "Ingreso  mensual a precios de Lima transferencia monetaria Otros Publica"
label var ipcr_16 "Ingreso  mensual a precios de Lima renta"
label var ipcr_17 "Ingreso  mensual a precios de Lima extraordinario"
label var ipcr_18 "Ingreso  mensual a precios de Lima alquiler imputado"
label var ipcr_19 "Ingreso  mensual a precios de Lima donacion publica"
label var ipcr_20 "Ingreso  mensual a precios de Lima donacion privada"



*** Ingreso real promedio mensual a nivel hogares ***

svyset [pweight = factor07], psu(conglome)strata(estrato)

svy:mean ipcr_0, over(aniorec) // Datos
